...
const Table = ({ data, pending, searchKeyWord, setSearchKeyWord, state, setState, setIsOpen,setFunctionData }) => {
    ...
    return (
        <div style={{ position: 'relative' }}>
            {showDatePicker === true && <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'absolute', zIndex: '999', background: 'rgb(248, 248, 248)', padding: '10px', borderRadius: '5px', border: '1px solid gray', flexDirection: 'column', gap: '10px', right: '0%', }}>
                <DateRange
